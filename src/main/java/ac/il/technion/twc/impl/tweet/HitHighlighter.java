...
public class HitHighlighter
{
	...
	/**
	 * Surround the <code>hits</code> in the provided <code>text</code> with an HTML tag. This is used with offsets from
	 * the search API to support the highlighting of query terms.
	 * 
	 * @param text
