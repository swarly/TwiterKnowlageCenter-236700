...
public class Regex
{
	...
	private static final String URL_VALID_GTLD = "(?:(?:"
			...
			+ "我爱你|政务|机构|游戏|移动|组织机构|网址|网络|集团|삼성" + ")(?=[^\\p{Alnum}@]|$))";
	...
	public static final Pattern RTL_CHARACTERS = Pattern
			.compile("[\u0600-\u06FF\u0750-\u077F\u0590-\u05FF\uFE70-\uFEFF]");
	...
	public static final Pattern VALID_CASHTAG = Pattern.compile("(^|" + UNICODE_SPACES + ")(" + DOLLAR_SIGN_CHAR + ")("
